...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "24433eaa2ec03b9a72b5";
...
function utils_css(domNode, rules) {
...
class table_selection_TableSelection {
  ...
  clearSelection() {
    ...
    this.selectedTds = [];
    LINE_POSITIONS.forEach(direction => {
      this[direction] && utils_css(this[direction], {
        display: 'none'
      });
    });
  }
...
// CONCATENATED MODULE: ./src/modules/table-moving-tool.js
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }


class table_moving_tool_TableMovingTool {
  ...
  constructor(table, quill, options) {
    ...
    _defineProperty(this, "boundDrag", this.dragMoveToolHandler.bind(this));

    _defineProperty(this, "boundMoving", this.movingTableHandler.bind(this));

    _defineProperty(this, "boundDrop", this.dropMoveToolHandler.bind(this));
  ...
  initMovingTool() {
    ...
    const tableViewRect = this.table.parentNode.getBoundingClientRect(); // css(this.domNode, {
    //     width: '22px',
    //     height: '22px',
    ...
    popper_createPopper(this.table, this.domNode, {
...
// CONCATENATED MODULE: ./src/modules/table-style-tool.js
function table_style_tool_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }



class table_style_tool_TableStyleTool {
  constructor(table, quill, options) {
    table_style_tool_defineProperty(this, "backgroundColorBound", this.backgroundColorHandler.bind(this));

    table_style_tool_defineProperty(this, "borderColorBound", this.borderColorHandler.bind(this));

    table_style_tool_defineProperty(this, "borderWidthBound", this.borderWidthHandler.bind(this));

    table_style_tool_defineProperty(this, "BorderStyleBound", this.borderStyleHandler.bind(this));

    table_style_tool_defineProperty(this, "backgroundColorBtn", void 0);

    table_style_tool_defineProperty(this, "borderColorBtn", void 0);

    table_style_tool_defineProperty(this, "borderWidthBtn", void 0);

    table_style_tool_defineProperty(this, "borderStyleBtn", void 0);
  ...
  createStyingItems() {
    ...
    </svg>`; // this.backgroundColorBtn.addEventListener('click', this.backgroundColorBound);
    ...
    this.borderStyleBtn.addEventListener('click', this.BorderStyleBound); // this.domNode.appendChild(this.backgroundColorBtn);
  ...
  borderColorHandler(e) {
    ...
    if (clickedElement === this.borderColorBtn) {
      ...
      this.createColorPicker(this.borderColorBtn, color => {
        ...
        if (!table) return; // console.log('found tds table', $(table).find('td'));

        jquery_default()(table).find('td').css('border-color', color);
      });
    }
  }
  ...
  borderWidthHandler(e) {
    ...
    if (clickedElement === this.borderWidthBtn) {
      this.destroyCurrentPicker();
      const table = this.table;
      this.createPicker(this.borderWidthBtn, [0, 1, 1.5, 1.75, 2.25, 3, 4.5, 6], width => {
        console.log('border width selected', width);
        if (!table) return;
        jquery_default()(table).find('td').css('border-width', `${width}px`);
      });
  ...
  borderStyleHandler(e) {
    ...
    if (clickedElement === this.borderStyleBtn) {
      ...
      this.createPicker(this.borderStyleBtn, ['solid', 'dotted', 'dashed'], style => {
        ...
        if (!table) return;
        jquery_default()(table).find('td').css('border-style', style);
      });
    } else if (clickedElement.className === 'qlbt-style-item') {
      const selectedCells = this.quill.getModule('better-table').getSelectedCells();
      if (!selectedCells) return;
  ...
  createColorPicker(colorPickerParent, colorSelectedHandler) {
    let colors = ['#000000', '#e60000', '#ff9900', '#ffff00', '#008a00', '#0066cc', '#9933ff', '#ffffff', '#facccc', '#ffebcc', '#ffffcc', '#cce8cc', '#cce0f5', '#ebd6ff', '#bbbbbb', '#f06666', '#ffc266', '#ffff66', '#66b966', '#66a3e0', '#c285ff', '#888888', '#a10000', '#b26b00', '#b2b200', '#006100', '#0047b2', '#6b24b2', '#444444', '#5c0000', '#663d00', '#666600', '#003700', '#002966', '#3d1466', 'transparent'];
  ...
  destroyCurrentPicker() {
    ...
    if (this.borderColorBtn.querySelector('span')) this.borderColorBtn.removeChild(this.borderColorBtn.querySelector('span'));else if (this.borderWidthBtn.querySelector('span')) this.borderWidthBtn.removeChild(this.borderWidthBtn.querySelector('span'));else if (this.borderStyleBtn.querySelector('span')) this.borderStyleBtn.removeChild(this.borderStyleBtn.querySelector('span'));
  }
...
class quill_better_table_BetterTable extends Module {
  ...
  showTableTools(table, quill, options) {
    ...
    this.movingTool = new table_moving_tool_TableMovingTool(table, quill, options);
    this.styleTool = new table_style_tool_TableStyleTool(table, quill, options);
  }
...
/* harmony import */ var src_assets_quill_better_table_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
